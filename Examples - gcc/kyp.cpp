...
class KMF
{
        ...
        public:
             ...
             {
                   x=a;y=b;i=d;j=e;color=c;t=text;
             };
             KMF(KMF& S)
             {
                   x=S.x;y=S.y;i=S.i;j=S.j;color=S.color;text=S.text;
             };
...
class MuHIo4
{
        ...
        public:
                ...
                void nepegBurM4()
                {
                        ...
                        paMka2.HapucoBaTbtxt(57,26,15,txt4);
                                                kakou=3; zHa4M4(kakou);
                                                break;
                                        case 27:
                                                kakou=0; zHa4M4(kakou);
                                                i=0;
                                                break;
                                        case 32:
                                                i=0;
        ...
        public:
                ...
                void nepegBurM3()
                {
                        ...
                        paMka2.HapucoBaTbtxt(42,20,15,txt4);
                                        ...
                                        case 32:
                                                MuHIo4 m;
                                                if (kakou==1) {i=0; zHa4M3(1);}
                                                else
                                                {
                                                m.nepegBurM4();
                                                if (m.zHa4M4()==0) i=1;
                                                if (m.zHa4M4()==3) {i=0; zHa4M3(3);};
                                                if (m.zHa4M4()==4) {i=0; zHa4M3(4);};
                                                }
                                                break;
                        ...
                        switch(getch())
                        {
                                ...
                                case 32:
                                        ...
                                        if (a<11)
                                        {
                                                ...
                                                if (m.zHa4M3()==1)
                                                {
                                                i=1; ty[z][c]=ty[z][c]+100;

                                                if (ty[z][c]<110) {ocT=ocT-1;kl.HapucoBaTbFoH(x2+1,y2+1,x2+3,y2+2,112);
                                                kl.HapucoBaTbK(x2,y2,x2+3,y2+2,112);gotoxy(x2+1,y2+1); cout<<ty[z][c]-100;
                                                };
                                                if (ty[z][c]==110) {kl.HapucoBaTbFoH(x2+1,y2+1,x2+3,y2+2,192);
                                                ...
                                                if (m.zHa4M3()==4)
                                                {i=1; ty[z][c]=ty[z][c]+200;
                                                kl.HapucoBaTbFoH(x2+1,y2+1,x2+3,y2+2,15);
                                                kl.HapucoBaTbK(x2,y2,x2+3,y2+2,144);
                                                kl.HapucoBaTbtxt(x2+1,y2+1,15,FJIar);
                                                if (ty[z][c]==210){yrag=yrag-1;ocT=ocT-1;
                                                }
                                                 else Heyrag=Heyrag+1;
                                                };
                                                if (m.zHa4M3()==3)
                                                {if (ty[z][c]==210) {yrag=yrag+1;ocT=ocT+1;i=1;}
                                                else Heyrag=Heyrag-1;
                                                ty[z][c]=ty[z][c]-200;kl.HapucoBaTbFoH(x2+1,y2+1,x2+3,y2+2,144);
                                                kl.HapucoBaTbK(x2,y2,x2+3,y2+2,144);
                                                };
                                        }
                                        else
