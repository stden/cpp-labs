...
public:
	...
	Owner& owner_get() { return *static_cast<Owner*>( this ); }
	...
	size_t	method_count() const { return _methods.size(); }
	Method* method_get( int idx ) { return _methods[idx]; }
	void	invoke( Method *m ) { m->call( owner_get(), &_args.front() ); }

public:

	static bool _id_less( T *a, T *b ) { return a->typeId_get() < b->typeId_get(); }
